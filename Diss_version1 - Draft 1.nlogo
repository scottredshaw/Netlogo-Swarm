breed [antisocial_agents antisocial_agent]
breed [social_agents social_agent]
...
to setup-obstacles
  ...
  ;ask n-of num-obstacles patches with [
  ;  distance 0 0 > 16 and abs pxcor < (max-pxcor - 2) and abs pycor < (max-pycor - 2)
  ;]
